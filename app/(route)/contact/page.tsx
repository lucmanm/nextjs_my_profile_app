...
const ContactPage = () => {
  ...
  return (
    <>
      <Button onClick={onSend}>Send Test Email</Button>
    </>
  );
  // return (
  //   <section>
  ...
  //           </p>
  //         </div>
  //         <div className="hidden xl:flex w-full bg-contact_illustration_light dark:bg-contact_illustrpation_dark bg-contain bg-top bg-no-repeat" />
  //       </div>
